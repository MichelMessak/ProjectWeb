...
<html>
    ...
    <body>
        ...
        <div id="mainContainer">
            <form:form method="POST" id="myForm" commandName="changePasswordForm">
               <fieldset>
                    <div class="fieldgroup">
                        <label>Entrer un nouveau Mot de Passe</label>
                        <form:password path="password" maxlength="40" htmlEscape="" title="Veuillez entrer un nouveau mot de passe"/>
                    ...
                    <div class="fieldgroup">
                        ...
                        <form:password path="confirmationPassword" maxlength="40" title="Comfirmer ce nouveau mot de passe"/>
                    ...
                    <div class="fieldgroup">
                        ...
                        <form:password path="password_actual" maxlength="40" title="Veuillez ajouter le mot de passe actuel"/>
    ...
    <div style="bottom: 8px;position: absolute;right: 1%;">
     ...
     <div id="popupHelp" class="avgrund-popup">
        ...
        <h3 align="center" style="font-size: 15px;"><p class="topHelp">Changer de Mot de Passe</p></h3><br>
        <p class="normalHelp" style="font-size: 15px;"></p>
        <p class="descripcionHelp" style="padding-bottom: 10px;">Dans ce menu nous pouvons changer de mot de passe.</p>
        <p class="noteHelp" style="padding-bottom: 10px;">Debemos digitar nuestra contrase&ntilde;a actual.</p>
        <p class="descripcionHelp" style="padding-top: 30px;">
            Pour valider le changement de mt de passe, appuyer sur le bouton ???
